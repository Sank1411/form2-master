...
class MainDept(models.Model):
    DEPT_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class SubDept(models.Model):
    SUBDEPT_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    ...
    DEPT_NO = models.ForeignKey(MainDept,default=1,on_delete=models.CASDADE)
    class Meta:
        db_table = "SUBDEPT"

class MainDesignation(models.Model):
    DESIG_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class SubDesignation(models.Model):
    SUBDESIG_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    ...
    DESIG_NO = models.ForeignKey(Designation,default=1,on_delete=models.CASDADE)
    class Meta:
        db_table = "SUBDESIG"

class Scale(models.Model):
    SCALE_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class Staff(models.Model):
    STAFF_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class Caste(models.Model):
    CASTE_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    CASTE_NAME = models.CharField(max_length=20,null=True, blank=True)
    class Meta:
        db_table = "CASTE"

class Category(models.Model):
    CATEGORY_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    CATEGORY_NAME = models.CharField(max_length=20,null=True, blank=True)
    class Meta:
        db_table = "CATEGORY"

class Religion(models.Model):
    RELIGION_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class Appointment(models.Model):
    APPOINT_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class SuplHead(models.Model):
    SUPLNO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    SUPLHEAD_NAME = models.CharField(max_length=30,null=True, blank=True)
    class Meta:
        db_table = "SUPLHEAD"

class Bank:
    BNO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class City:
    CITY_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    CITY_NAME = models.CharField(max_length=25,null=True, blank=True)
    class Meta:
        db_table = "CITY"

class Title(models.Model):
    TITLE_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    TITLE_NAME = models.CharField(max_length=20,null=True, blank=True)
    class Meta:
        db_table = "TITLE"

class TypeTran(models.Model):
    TYPETRAN_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class UnderCollege(models.Model):
    UNO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class StaffType(models.Model):
    STNO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
    STAFF_TYPE = models.CharField(max_length=20,null=True, blank=True)
    class Meta:
        db_table = "STAFFTYPE"

class InstallmentType(models.Model):
    INO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
...
class Designature(models.Model):
    DESIGNATURE_NO = models.IntegerField(default=None,null=True, blank=True,primary_key=True)
